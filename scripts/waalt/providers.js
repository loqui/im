...
var Providers = {
  ...
  data: {
    ...
    'facebook': {
      ...
      lacks: ['multi', 'avatarChange', 'statusChange', 'attention', 'rosterMgmt', 'receipts', 'localContacts', 'pay'],
      color: '#3D539F',
      terms: {
    ...
    'hangouts': {
      ...
      lacks: ['avatarChange', 'receipts', 'localContacts', 'pay'],
      color: '#4EA43B',
      terms: {
    ...
    'nimbuzz': {
      ...
      lacks: ['vcard', 'avatarChange', 'attention', 'receipts', 'localContacts', 'pay'],
      color: '#FF8702',
      terms: {
        user: 'Username',
        pass: 'Password',
    ...
    'ovi': {
      ...
      lacks: ['avatarChange', 'attention', 'receipts', 'localContacts', 'pay'],
      color: '#39B006',
      terms: {
        user: 'Username',
        pass: 'Password',
    ...
    'xmpp': {
      ...
      autodomain: false,
      lacks: ['receipts', 'localContacts', 'pay'],
      color: '#149ED2',
      terms: {
        user: 'FullJID',
        pass: 'Password',
